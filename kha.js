...
var Empty = function() {
	...
	this.totalFrames = 0;
	this.deltaTime = 0.0;
	this.backgroundColor = -14011577;
	this.gravity = 0.5;
	this.bCount = 0;
	var _gthis = this;
	kha_Assets.loadEverything(function() {
		_gthis.font = kha_Assets.fonts.mainfont;
		_gthis.bunnyTex = kha_Assets.images.wabbit_alpha;
		_gthis.bunnies = [];
		_gthis.minX = 0;
		var tmp = _gthis.bunnyTex.get_width();
		_gthis.maxX = 800 - tmp;
		_gthis.minY = 0;
		var tmp1 = _gthis.bunnyTex.get_height();
		_gthis.maxY = 600 - tmp1;
		kha_input_Mouse.get().notify($bind(_gthis,_gthis.mouseDown),null,null,null);
		kha_Scheduler.addTimeTask($bind(_gthis,_gthis.update),0,0.016666666666666666);
...
Empty.prototype = {
	...
	,mouseDown: function(button,x,y) {
		...
		this.bCount = this.bunnies.length;
	}
	,update: function() {
		var _g = 0;
		var _g1 = this.bunnies.length;
		while(_g < _g1) {
			var i = _g++;
	...
	,render: function(framebuffer) {
		...
		this.totalFrames++;
		framebuffer.get_g2().begin(true,this.backgroundColor);
		...
		while(_g < _g1.length) {
			var bunny = _g1[_g];
			++_g;
			framebuffer.get_g2().drawImage(this.bunnyTex,bunny.x,bunny.y);
		}
		framebuffer.get_g2().set_font(this.font);
		framebuffer.get_g2().set_fontSize(16);
		framebuffer.get_g2().set_color(-16777216);
		framebuffer.get_g2().fillRect(0,0,800,20);
		framebuffer.get_g2().set_color(-1);
		framebuffer.get_g2().drawString("bunnies: " + this.bCount + "         fps: " + this.fps,10,2);
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "BynnyMark", width : 800, height : 600},function() {
		new Empty();
	});
};
Math.__name__ = true;
...
var kha__$Assets_ImageList = function() {
	this.names = ["fill","wabbit_alpha"];
	this.wabbit_alphaDescription = { name : "wabbit_alpha", original_height : 37, original_width : 26, files : ["wabbit_alpha.png"], type : "image"};
	this.wabbit_alphaName = "wabbit_alpha";
	this.wabbit_alpha = null;
	this.fillDescription = { name : "fill", original_height : 10, original_width : 10, files : ["fill.png"], type : "image"};
	this.fillName = "fill";
	this.fill = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,fillLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "fillLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("fill",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "fillLoad"});
	}
	,fillUnload: function() {
		this.fill.unload();
		this.fill = null;
	...
	,wabbit_alpha: null
	,wabbit_alphaName: null
	,wabbit_alphaDescription: null
	,wabbit_alphaLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "wabbit_alphaLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadImage("wabbit_alpha",function(image) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 132, className : "kha._Assets.ImageList", methodName : "wabbit_alphaLoad"});
	}
	,wabbit_alphaUnload: function() {
		this.wabbit_alpha.unload();
		this.wabbit_alpha = null;
	}
	,names: null
...
kha__$Assets_FontList.prototype = {
	...
	,mainfontLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 144, className : "kha._Assets.FontList", methodName : "mainfontLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadFont("mainfont",function(font) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 144, className : "kha._Assets.FontList", methodName : "mainfontLoad"});
	}
	,mainfontUnload: function() {
		this.mainfont.unload();
		this.mainfont = null;
	}
	,names: null
...
kha_CompilerDefines["source-header"] = "Generated by Haxe 4.0.0-rc.1+e9fdf59";
kha_CompilerDefines.script_name = "kha";
kha_CompilerDefines.kha_webgl = "1";
kha_CompilerDefines.kha_version = "1810";
kha_CompilerDefines.kha_project_name = "New Project";
...
kha_CompilerDefines.hxcpp_smart_strings = "1";
kha_CompilerDefines.haxe_ver = "4.000";
kha_CompilerDefines.haxe4 = "1";
