...
var kha__$Assets_ImageList = function() {
	...
	this.wabbit_alphaDescription = { files : ["wabbit_alpha.png"], original_height : 37, type : "image", original_width : 26, name : "wabbit_alpha"};
	this.wabbit_alphaName = "wabbit_alpha";
	this.wabbit_alpha = null;
	this.fillDescription = { files : ["fill.png"], original_height : 10, type : "image", original_width : 10, name : "fill"};
	this.fillName = "fill";
	this.fill = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,fillLoad: function(done,failure) {
		...
		if(failure != null) {
			...
			tmp = function(v) {
				f(v,{ fileName : "AssetsBuilder.hx", lineNumber : 130, className : "kha._Assets.ImageList", methodName : "fillLoad"});
			};
		}
		kha_Assets.loadImage("fill",function(image) {
			done();
		},tmp,{ fileName : "AssetsBuilder.hx", lineNumber : 130, className : "kha._Assets.ImageList", methodName : "fillLoad"});
	}
	,fillUnload: function() {
		this.fill.unload();
		this.fill = null;
	...
	,wabbit_alphaLoad: function(done,failure) {
		...
		if(failure != null) {
			...
			var f = haxe_Log.trace;
			tmp = function(v) {
				f(v,{ fileName : "AssetsBuilder.hx", lineNumber : 130, className : "kha._Assets.ImageList", methodName : "wabbit_alphaLoad"});
			};
		}
		kha_Assets.loadImage("wabbit_alpha",function(image) {
			done();
		},tmp,{ fileName : "AssetsBuilder.hx", lineNumber : 130, className : "kha._Assets.ImageList", methodName : "wabbit_alphaLoad"});
	}
...
var kha__$Assets_FontList = function() {
	this.names = ["mainfont"];
	this.mainfontDescription = { files : ["mainfont.ttf"], type : "font", name : "mainfont"};
...
kha__$Assets_FontList.prototype = {
	...
	,mainfontLoad: function(done,failure) {
		...
		if(failure != null) {
			...
			var f = haxe_Log.trace;
			tmp = function(v) {
				f(v,{ fileName : "AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "mainfontLoad"});
			};
		}
		kha_Assets.loadFont("mainfont",function(font) {
			done();
		},tmp,{ fileName : "AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "mainfontLoad"});
	}
